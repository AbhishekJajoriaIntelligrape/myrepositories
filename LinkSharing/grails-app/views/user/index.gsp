...
<html>
		...
		<div id="list-user" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="invited" title="Send Invites" />
    ...
    <div id="invites" align="left"><button name="sendInvites">Send Invites</button></div>
